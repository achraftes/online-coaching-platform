<div class="relative w-full overflow-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64 bg-gradient-to-r from-indigo-500 to-indigo-700 text-white">
    <div class="container mx-auto flex flex-col items-center justify-between h-full max-w-6xl px-8 lg:flex-row xl:px-0">
        <!-- Text Section -->
        <div class="flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
            <h1 class="relative mb-6 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl xl:mb-8 text-white">
                Libérez votre <br>plein potentiel
            </h1>
            <p class="mb-6 text-lg sm:text-xl xl:text-2xl lg:pr-20 text-gray-200">
                Coaching sur mesure pour accélérer votre carrière et atteindre vos objectifs professionnels.
            </p>
            <a href="#" onclick="showModal()" class="relative inline-block w-auto px-8 py-4 mx-auto mt-4 text-base font-bold text-indigo-600 bg-white border-t border-gray-200 rounded-md shadow-lg hover:bg-indigo-50 transition duration-300 ease-in-out transform hover:scale-105">
                Prenez un Rendez-vous
            </a>

            <!-- Integrates with section -->
            <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                <p class="mb-4 text-sm font-medium tracking-widest text-gray-300 uppercase">Intégrations Avec</p>
                <div class="flex space-x-4">
                    <svg class="h-8 text-gray-300 hover:text-white duration-150 cursor-pointer fill-current transition-colors">
                    ...
                    <svg class="h-8 text-gray-300 hover:text-white duration-150 cursor-pointer fill-current transition-colors">
                        <path d="M1175 0C525.8 0 0 525.8 0 1175c0 552.2 378.9 1010.5 890.1 1139.7-5.9-14.7-8.8-35.3-8.8-55.8v-199.8H734.4c-79.3 0-152.8-35.2-185.1-99.9-38.2-70.5-44.1-179.2-141-246.8-29.4-23.5-5.9-47 26.4-44.1 61.7 5.3 89 33.4 119.8 65.2 20.7 34.1 36.3 54.6 76.3 59.8h137.3v94.9h81.4c29.7 0 53.7 10.9 78.2 35.1 12.6 12.5 24.4 25.6 35.8 39.3 16.6 28.9 29.4 62.7 30.2 98.1 2.1 41.8-16.2 82.4-46.7 113.2-48.6 48.2-115.3 60.5-174.4 91.9h43.6c33.5 16.5 68.9 34.6 96.5 63.9 29.9 31.9 37.2 60.7 23.7 96.8 17.5 5.4 17.7 1 5.7 17z"/>
                    </svg>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-center lg:w-1/2">
            <img class="w-full h-auto rounded-xl shadow-2xl transform transition-all hover:scale-105" src="https://www.example.com/path/to/your/image.jpg" alt="Coaching Image">
        </div>
    </div>
</div>
