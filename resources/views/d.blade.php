...
<body class="overflow-x-hidden antialiased">
        ...
        <div
            ...
            <nav id="nav"
                ...
                <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                    ...
                    <a href="#" onclick="showModal(); event.preventDefault();"
                        class="relative inline-block w-full px-5 py-3 text-sm font-bold text-center text-white bg-indigo-700 rounded-md shadow-md hover:bg-indigo-800">
                        Get Started
                    </a>
    ...
    <!-- HERO SECTION END -->
    <!-- SECTION TEST AVEC BOUTONS ENTIERS -->
    <div id="features"
        ...
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
                ...
                <form id="userForm">
                    ...
                    <div class="form-group">
                        ...
                        <select id="service" name="service" required>
                            ...
                            <option value="Coaching Confiance en Soi">Coaching Confiance en Soi</option>
                            <option value="Coaching Gestion du Stress">Coaching Gestion du Stress</option>
                            <option value="Coaching Équilibre de Vie">Coaching Équilibre de Vie</option>
                            <option value="Coaching Motivation">Coaching Motivation</option>
                            <option value="Coaching Transition">Coaching Transition</option>
                        </select>
                    </div>
            ...
            <div id="resultMessage" class="hidden">
                <h1>Merci d’avoir complété le test ! Votre bilan personnalisé vous a été envoyé par email. Pensez à
                    vérifier vos spams si vous ne le recevez pas dans quelques minutes.</h1>
            </div>
        </div>
    </div>
    <!-- END TEST SECTION -->
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Nos Tarifs</h2>
            <h3
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            ...
                            <div class="flex items-center block p-8 uppercase">
                                <button type="button" onclick="showModal()"
                                    class="select-plan-btn block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-indigo-600">Select
                                    This Plan</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                            ...
                            <div class="flex items-center block p-8 uppercase">
                                <button type="button" onclick="showModal()"
                                    class="select-plan-btn block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-green-600">Select
                                    This Plan</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Masquer le contenu initial et afficher le quiz
